...
I<The present distribution is a partial, but operational implementation of the lpOD functional specifications. The documented features will be extended, but should not be removed.>
...
L<ODF::lpOD::Style>: Text style retrieval, update, or creation
